                                ...
                                <div class="column">
                                    {#if project.media.includes('gfycat')}
                                        <div style='position:relative; padding-bottom:calc(56.25% + 44px)'>
                                            <iframe title="gfycat" alt="preview of how {project.project} looks" src={project.media} frameborder='0' scrolling='no' width='100%' height='100%' style='position:absolute;top:0;left:0;' allowfullscreen/>
                                        </div>
                                    {:else}
                                        <figure class="image">
