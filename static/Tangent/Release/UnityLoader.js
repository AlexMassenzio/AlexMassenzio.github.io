	...
	if (!Math.fround && n && 'asmUrl' == n.id) {
		...
		for (
			...
			if (
				...
				47 == e[s + 1] &&
				32 == e[s + 2] &&
				String.fromCharCode.apply(null, e.subarray(s + 3, s + 3 + i[d].length)) === i[d]
			)
				d++;
			else if (
				...
				u ||
				61 != e[s] ||
				String.fromCharCode.apply(null, e.subarray(s + 1, s + 1 + r.length)) !== r
			) {
				if (u && 40 == e[s]) {
				...
				(u && String.fromCharCode.apply(null, e.subarray(l - u - a.length, l - u)) === a) ||
					(l = u = 0);
			}
	}
...
function demangleSymbol(e) {
	return (
		Module.debugSymbols && Module.debugSymbols[e] && (e = Module.debugSymbols[e]),
...
function demangleError(e) {
	...
	return e.replace(n, function (e) {
		var t = e.match(o),
			...
			a =
				i && Module.blobInfo && Module.blobInfo[i[1]] && Module.blobInfo[i[1]].url
				...
				function (e, t, n) {
					...
					function f(e, t) {
							...
							switch (n.mode) {
								...
								case ee:
									...
									if (
										...
										(xe = { bits: n.distbits }),
										(Se = y(x, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, xe)),
										(n.distbits = xe.bits),
										Se)
									) {
								...
								case ne:
									...
									if (we && 0 === (240 & we)) {
										for (
											ve = be, ke = we, ye = ge;
											(Ce = n.lencode[ye + ((f & ((1 << (ve + ke)) - 1)) >> ve)]),
												(be = Ce >>> 24),
												(we = (Ce >>> 16) & 255),
												(ge = 65535 & Ce),
												!(h >= ve + be);
								...
								case ie:
									...
									if (0 === (240 & we)) {
										for (
											ve = be, ke = we, ye = ge;
											(Ce = n.distcode[ye + ((f & ((1 << (ve + ke)) - 1)) >> ve)]),
												(be = Ce >>> 24),
												(we = (Ce >>> 16) & 255),
												(ge = 65535 & Ce),
												!(h >= ve + be);
								...
								case de:
									if (n.wrap) {
										...
										if (
											...
											p &&
												(e.adler = n.check =
													n.flags ? v(n.check, a, p, s - p) : g(n.check, a, p, s - p)),
											(p = l),
						...
						return (
							...
							(n.hold = f),
							(n.bits = h),
							(n.wsize || (p !== e.avail_out && n.mode < ce && (n.mode < de || t !== M))) &&
					...
					function m(e, t) {
						var n;
						return e && e.state
							? ((n = e.state), 0 === (2 & n.wrap) ? L : ((n.head = t), (t.done = !1), D))
							: L;
					}
					var p,
						b,
				...
				function (e, t, n) {
					...
					((h.prototype.push = function (e, t) {
						...
						do {
							if (
								(0 === c.avail_out &&
									((c.output = new r.Buf8(h)), (c.next_out = 0), (c.avail_out = h)),
...
('undefined' == typeof Module &&
	...
	(function () {
		...
		e({
			files: [
				{ audio: 0, start: 0, crunched: 0, end: 1783925, filename: '/data.unity3d' },
				{
					audio: 0,
					start: 1783925,
					crunched: 0,
